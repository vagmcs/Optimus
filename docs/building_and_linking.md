...
Optimus is published into the Maven Central. In order to link Optimus `core` module (e.g., version 3.4.0) to your [SBT](http://www.scala-sbt.org/) project, add the following dependency:

```scala
libraryDependencies += "com.github.vagmcs" %% "optimus" % "3.4.0"
```
...
```scala
libraryDependencies += "com.github.vagmcs" %% "optimus-solver-oj" % "3.4.0"
libraryDependencies += "com.github.vagmcs" %% "optimus-solver-lp" % "3.4.0"
libraryDependencies += "com.github.vagmcs" %% "optimus-solver-gurobi" % "3.4.0"
libraryDependencies += "com.github.vagmcs" %% "optimus-solver-mosek" % "3.4.0"
```
